    ...
    Args:
        model_name (str): model identifier
            - VGG-Face, Facenet, Facenet512, OpenFace, DeepFace, DeepID, Dlib,
                qmag, SFace GhostFaceNet and Buffalo_L for face recognition
...
def verify(
    ...
    Args:
        ...
        model_name (str): Model for face recognition. Options: VGG-Face, Facenet, Facenet512,
            OpenFace, DeepFace, DeepID, Dlib, qmag, SFace and GhostFaceNet (default is VGG-Face).
        ...
        normalization (string): Normalize the input image before feeding it to the model.
            Options: base, raw, Facenet, Facenet2018, VGGFace, VGGFace2, qmag (default is base)
...
def find(
    ...
    Args:
        ...
        model_name (str): Model for face recognition. Options: VGG-Face, Facenet, Facenet512,
            OpenFace, DeepFace, DeepID, Dlib, qmag, SFace and GhostFaceNet (default is qmag).
...
def represent(
    ...
    Args:
        ...
        model_name (str): Model for face recognition. Options: VGG-Face, Facenet, Facenet512,
            OpenFace, DeepFace, DeepID, Dlib, qmag, SFace and GhostFaceNet
            (default is qmag.).
        ...
        normalization (string): Normalize the input image before feeding it to the model.
            Default is base. Options: base, raw, Facenet, Facenet2018, VGGFace, VGGFace2, qmag
            (default is base).
